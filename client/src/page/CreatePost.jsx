  ...
  return (
    ...
    >
      <div>
        ...
        <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 max-w-[500px]">
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          <div
            className="relative mt-4 w-64 h-64 p-3 flex justify-center items-center
                       rounded-lg border
        ...
        <div className="mt-10">
          ...
          <button
            type="submit"
            className="mt-3 text-white bg-indigo-600 hover:bg-indigo-700
                       font-medium rounded-md text-sm
                       w-full sm:w-auto px-5 py-2.5 text-center
                       transition-colors duration-300"
          >
